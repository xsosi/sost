RAID = [
    "ALLHA KI MAA KA BHOSDA RAND ALLHA",
    "HALALA KI AULAD",
    "ALHA MERE LAND PE AWR TERI MAA KI CHUT",
    "ZARA SE PILOGE GHANTE HILOGE 🤣",
    "MUTH DIYA MAJIDO ME",
    "LAND ME QURAN AWR LAND PE ISLAM",
    "TERE ALLHA KI MAA KA BHOSDA",
    "POISON OP ❤️💫",
    "DANGEROUS FIGHTERS OP",
    "LAND LAND ISLAM KI MAA KA BHOSDA ",
